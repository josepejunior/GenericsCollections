...
// Mostrar en consola todos nùmeros primos
...
// Mostar la suma de todos los elementos 
...
Console.WriteLine($"\nEl promedio de los números mayores a 50: {promedioMayoresA50}");

// Contar la cantidad de números pares e impares en una única consulta
var conteoParesImpares = numeros.GroupBy(num => num % 2 == 0)
                                .ToDictionary(group => group.Key ? "Pares" : "Imprares", 
                                 group => group.Count());
...
// Contar la frecuencia de cada numero de la lista 1, 2, 1, 2, 3, 1
...
Console.WriteLine("\nCantidad de numeros en la lista (1, 2, 1, 2, 3, 1)");
